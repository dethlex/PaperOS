...
extern const char* const kEn[] = {
    ...
    "Updated %s",
    "Printing", "Paused", "Idle",
    "Complete", "Cancelled", "Error",
    "Hotend", "Bed", "Layer %d / %d", "elapsed",
    "left", "Light", "On", "Off", "Set printer.url in config.json",
    "Klipper: %s", "Printer",
    "Power", "Move", "Home", "Preheat", "Cooldown",
    "Print history", "No history", "Turn on power", "Printer not ready",
    "Klipper starting...", "Restart Klipper", "Action failed",
    "Cancel", "Cancel the print?", "Start \"%s\"?",
    "Turn off power?", "Restart Klipper?", "Yes", "No",
    "Slicer",
    "Pause", "Resume", "Pause the print?", "Heat %d/%d",
    "Powered off",
    "Calendar", "Today", "Tomorrow", "all day", "No events",
    "No calendar selected", "Open Settings", "+%d more", "(untitled)",
    "HA unreachable", "Select calendar", "OK, %d events",
};
